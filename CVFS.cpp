...
void  man(char *name)
{
    ...
    else if(strcmp(name,"lsseek")== 0)
    {
        printf("Description : Used to change the file Offset\n");
        printf("Usage :lsseek File_Name ChangeInOffset StartPoint\n");
    }
      ...
      // scanf("%[^'\n']s",str);
       ...
       else if(count == 2)
       {
         ...
         else if(strcmp(command[0],"write") == 0)
         {
             ...
             if(ret == -3)
                printf("ERROR : It is no a regular file\n");
           }
       ...
       else if(count == 3)
       {
            ...
            else if(strcmp(command[0],"open") == 0)
            {
                ...
                if(ret >= 0)
                    printf("File Sucesfully Opened with File Descriptor : %d\n",ret);
                if(ret == -1)
            ...
            else if(strcmp(command[0],"read") == 0)
            {
                ...
                if(ptr == NULL)
                {
                    printf("ERROR : Memory Allocqtion Failure\n");
                    continue;
                }
